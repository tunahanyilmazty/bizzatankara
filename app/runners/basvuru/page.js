    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .submit-btn{width:100%;padding:16px;background:#120a94;color:#fff;border:1.5px solid #2D6FFF;border-radius:12px;font-family:'DM Sans',sans-serif;font-size:1rem;font-weight:700;cursor:pointer;transition:all 0.2s;margin-top:8px;letter-spacing:0.02em}
        ...
        .back-link{display:inline-block;color:#2D6FFF;font-size:0.88rem;font-weight:600;text-decoration:none;letter-spacing:0.04em}
        ...
        .kvkk-modal h2{font-family:'Poppins',sans-serif;font-weight:800;font-size:1.2rem;color:#FAF7F2;margin-bottom:20px;letter-spacing:-0.02em}
            ...
            {done ? (
              <div className="success-wrap">
                ...
                <p className="success-sub">
                  Harika! Başvurunu aldık, en kısa sürede seninle iletişime geçeceğiz.<br/>
                  Bizi Instagram&apos;dan takip etmeyi unutma.
                </p>
                <a href="https://instagram.com/bizzatrunners" target="_blank" rel="noopener noreferrer" className="back-link">
                  @bizzatrunners ↗
                </a>
              </div>
            ) : (
              <form onSubmit={submit}>
                <div className="field-row">
                  ...
                  <div className="field">
                    <label>Kaç Yaşındasın?<span>*</span></label>
